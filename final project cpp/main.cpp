...
#define Sleep(x) std::cout << "Sleeping for X minutes "
using namespace std;
struct wash {
    int* pntr; // POINTER
    int add;
...
int main()
{
    ...
    *wash.pntr = wash.add; // DECLARATION OF POINTERS
    ...
    do // WHEN YOU TYPE "1" AT THE END OF THIS PROGRAM, THE PROGRAM WILL RUN FROM THE MAIN FUNCTION
    {
        ...
        cout << "			--------------------------------------------------\n\n";
        cout << "please select operation" << endl << "1. wash" << endl << "2. dry" << endl << endl;
        cin >> operation;
        cout << endl;
        do {
            if (operation == "1") {
        ...
        cout << "Please Select Machine Size:" << endl << "1. Normal (1kg -  5kg)" << endl << "2. Large  (6kg to 10kg)" << endl << endl;
        cin >> type;
        do {
            if (type == "1") {
        ...
        Sleep(400);
        if (operation == "1") {
            cout << "\nPlease Select Wash Type:" << endl << "1. Warm" << endl << "2. Hot " << endl << "3. Cold" << endl << endl;
            cin >> type_wash;
            do {
                if (type_wash == "1") {
                    price += 3.5;
        ...
        cout << "\nPlease Select Service Time: " << endl << "1. 30 Minutes " << endl << "2. 20 Minutes " << endl << "3. 10 Minutes" << endl << endl;
        cin >> standar_ret;
        do {
            if (standar_ret == "1") {
                Sleep(1 * 1000);
        ...
        if (wash.answ_add == 'y' || wash.answ_add == 'Y') {
            Sleep(400);
            cout << "\nPlease Select Dryer Type:" << endl << "1. Thermal dryer" << endl << "2. Air dryer" << endl << endl;
            cin >> *wash.pntr;
            ...
            do {
                if (*wash.pntr == 1) {
                    ...
                    Sleep(400);
                    cout << "\nInvalid Input! " << endl << "Please Try again: " << endl;
                    cin >> *wash.pntr;
                }
            ...
            Sleep(400);
            cout << "\nNo Dryer Type Selected!" << endl << "Proceeding..." << endl << endl;
        }
        summery();
        Sleep(600);
